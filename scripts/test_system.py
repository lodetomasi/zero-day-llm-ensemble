...
VERIFIED_ZERO_DAYS = [
    ...
    # Additional verified zero-days (2024-2023)
    ...
    "CVE-2023-21554",  # Microsoft Message Queue
    "CVE-2023-4863",   # Chrome WebP
    
    # Additional 2022-2021 zero-days
    "CVE-2022-24521",  # Windows CLFS
    "CVE-2022-30333",  # UnRAR path traversal
    "CVE-2022-35405",  # Zoho ManageEngine
    "CVE-2022-36804",  # Atlassian Bitbucket
    "CVE-2021-30860",  # Apple FORCEDENTRY
    "CVE-2021-1675",   # PrintNightmare
    "CVE-2021-26855",  # Exchange ProxyLogon
    "CVE-2021-21972",  # VMware vCenter
    "CVE-2021-20016",  # SonicWall SMA
    
    # Additional 2020-2019 zero-days
    "CVE-2020-0688",   # Exchange control panel
    "CVE-2020-16898",  # Windows TCP/IP (Bad Neighbor)
    "CVE-2019-1367",   # IE scripting engine
]
...
VERIFIED_REGULAR_CVES = [
    ...
    # Additional 2024 responsible disclosures
    "CVE-2024-45409",  # GitLab CE/EE - researcher
    "CVE-2024-38077",  # Windows Remote Desktop
    "CVE-2024-38112",  # Windows MSHTML
    "CVE-2024-29988",  # SmartScreen bypass
    "CVE-2024-26218",  # Windows Kernel
    
    # Additional 2023 responsible disclosures
    "CVE-2023-40477",  # WinRAR - researcher
    "CVE-2023-36802",  # Windows Streaming Service
    "CVE-2023-29336",  # Win32k elevation
    "CVE-2023-21823",  # Windows Graphics
    "CVE-2023-28303",  # Windows Snipping Tool
    "CVE-2023-1389",   # TP-Link Archer
    
    # Additional 2022 responsible disclosures
    "CVE-2022-44698",  # Windows SmartScreen
    "CVE-2022-41128",  # Windows Scripting
    "CVE-2022-38028",  # Windows Print Spooler
    "CVE-2022-34718",  # Windows TCP/IP
    "CVE-2022-30206",  # Windows Print Spooler
    "CVE-2022-26809",  # Windows RPC
    
    # Additional 2021 responsible disclosures
    "CVE-2021-36958",  # Windows Print Spooler
    "CVE-2021-33739",  # Windows DWM
    "CVE-2021-31956",  # Windows NTFS
    "CVE-2021-28310",  # Win32k
    "CVE-2021-1732",   # Windows Win32k
    
    # Additional older responsible disclosures
    "CVE-2020-1350",   # Windows DNS (SIGRed)
    "CVE-2020-0796",   # SMBGhost
    "CVE-2019-1181",   # Windows RDP
    "CVE-2019-1182",   # Windows RDP
    "CVE-2018-8453",   # Windows Win32k
    "CVE-2017-11882",  # Office Equation Editor
    "CVE-2017-0199",   # Office/WordPad
    "CVE-2016-3351",   # Android Broadcom WiFi
]
